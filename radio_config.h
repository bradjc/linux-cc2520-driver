...
static cc2520_frmctrl0_t cc2520_frmctrl0_default = {.f.autoack = 1,
                                                    .f.autocrc = 1};
...
// the sync word
static cc2520_mdmctrl0_t cc2520_mdmctrl0_default = {.f.tx_filter = 1,
                                                    .f.preamble_length = 2,
                                                    .f.demod_avg_mode = 0,
                                                    .f.dem_num_zeros = 2};
...
// threshold
static cc2520_mdmctrl1_t cc2520_mdmctrl1_default = {.f.corr_thr = 0x14,
                                                    .f.corr_thr_sfd = 0};
...
static cc2520_frmfilt0_t cc2520_frmfilt0_default = {.f.max_frame_version = 2,
                                                    .f.frame_filter_en = 0};

static cc2520_frmfilt1_t cc2520_frmfilt1_default = {.f.accept_ft_0_beacon = 1,
                                                    .f.accept_ft_1_data = 1,
                                                    .f.accept_ft_2_ack = 1,
                                                    .f.accept_ft_3_mac_cmd = 1,
                                                    .f.accept_ft_4to7_reserved = 1};

static cc2520_srcmatch_t cc2520_srcmatch_default = {.f.src_match_en = 0,
                                                    .f.autopend = 1,
